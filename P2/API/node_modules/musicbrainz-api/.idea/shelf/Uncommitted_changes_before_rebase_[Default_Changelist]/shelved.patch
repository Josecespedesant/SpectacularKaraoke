...
<+>UTF-8
===================================================================
--- src/musicbrainz-api.ts	(revision 7498c55a88089fbe5d6db9207caed2e39aa1b174)
+++ src/musicbrainz-api.ts	(date 1616272047585)
@@ -4,22 +4,24 @@
 import * as Url from 'url';
 import * as Debug from 'debug';
...
-        return true;
-    }
+    // this.options.cookieJar.getCookieString('musicbrainz_server_session');
+
+    // for (const cookie of session.cookies) {
+    //  if (this.options.cookieJar.getCookieString('musicbrainz_server_session'))
+    //    return true;
+    // }
...
-      response = await this.request.post({
-        uri: `/${entity}/${mbid}/edit`,
+      response = await got.post(`/${entity}/${mbid}/edit`, {
         form: formData,
-        followRedirect: false
+        followRedirect: false,
+        ...this.options
...
@@ -424,7 +425,7 @@
       ...
       for (const i in recording.isrcs) {
-        formData[`edit-recording.isrcs.${i}`] = recording.isrcs[i];
+        formData.append(`edit-recording.isrcs.${i}`, recording.isrcs[i]);
       }
       return this.editEntity('recording', recording.id, formData);
     }
@@ -507,17 +508,20 @@
...
+
+    const getCookies = promisify((this.options.cookieJar as tough.CookieJar).getCookies.bind(this.options.cookieJar));
+    const cookies = await getCookies(this.options.prefixUrl);
...
<+>UTF-8
===================================================================
--- package.json	(revision 7498c55a88089fbe5d6db9207caed2e39aa1b174)
+++ package.json	(date 1616270796853)
@@ -55,12 +55,12 @@
     "@types/uuid": "^3.4.6",
     "caseless": "^0.12.0",
     "debug": "^4.1.1",
