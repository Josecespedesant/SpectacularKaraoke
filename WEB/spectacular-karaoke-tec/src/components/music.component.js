    ...
    return (
      <div class="card mb-4">
        <div class="card-header">
          ...
          <div class="progress">
            <div class="progress-bar" role="progressbar" style={{ width: (this.audio.currentTime/this.audio.duration)*1240}} aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
